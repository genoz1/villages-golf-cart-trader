// ── DATA STORE ─────────────────────────────────────────────────────────────
const LISTINGS = [
  { id:1, title:"2022 Club Car Onward Lithium", price:12995, make:"Club Car", model:"Onward", year:2022, power:"Lithium", seats:4, location:"The Villages", type:"Featured", status:"Active", photo:"https://www.peeblesgolfcars.com/cdn/shop/files/2022_Club_Car_Onward_HP_Lithium_Ion_Glacier_White_1.jpg", daysLeft:27, seller:"John M.", phone:"(352) 555-0101", desc:"Clean 4-passenger lithium cart with upgraded premium seats, full LED lighting package, fold-down windshield, side mirrors, rear seat flip kit, and chrome accents. Garage kept, lightly used in The Villages. Runs perfectly." },
  { id:2, title:"2020 EZGO RXV Electric", price:8750, make:"EZGO", model:"RXV", year:2020, power:"Electric", seats:4, location:"Lady Lake", type:"Local", status:"Active", photo:"https://boterocarts.com/cdn/shop/products/2020-ezgo-freedom-rxv-elite-lithium-electric-golf-cart-botero-carts-1.jpg", daysLeft:3, seller:"Carol B.", phone:"(352) 555-0202", desc:"Well-maintained EZGO RXV with new batteries (2023), street legal package, custom rear seat, and USB charging port. Non-smoking owner. Stored indoors." },
  { id:3, title:"2023 Yamaha Drive2 Gas", price:10900, make:"Yamaha", model:"Drive2", year:2023, power:"Gas", seats:2, location:"Wildwood", type:"Local", status:"Active", photo:"https://thevillagesgolfcars.com/wp-content/uploads/2023/08/2023-Yamaha-Drive2-scaled.jpg", daysLeft:18, seller:"Mike T.", phone:"(352) 555-0303", desc:"Nearly new 2023 Yamaha Drive2 with only 200 miles. All original, full warranty still active. Street legal, custom wheels, and upgraded sound system." },
  { id:4, title:"2019 Club Car Precedent", price:6995, make:"Club Car", model:"Precedent", year:2019, power:"Electric", seats:4, location:"Oxford", type:"Local", status:"Active", photo:"https://www.peeblesgolfcars.com/cdn/shop/products/2019-Club-Car-Precedent-Lime-Green-Electric-4-Seater.jpg", daysLeft:22, seller:"Linda R.", phone:"(352) 555-0404", desc:"Dependable Club Car Precedent with new 48V batteries, upgraded headlights and taillights, and fold-down windshield. Great daily driver in The Villages." },
  { id:5, title:"2021 Evolution D5 Lifted", price:13500, make:"Evolution", model:"D5", year:2021, power:"Lithium", seats:6, location:"The Villages", type:"Featured", status:"Active", photo:"https://evolutionelectricvehicle.com/wp-content/uploads/2022/04/D5-6-Passenger.jpg", daysLeft:14, seller:"Dave K.", phone:"(352) 555-0505", desc:"Lifted 6-passenger Evolution D5 with 4-inch lift kit, all-terrain tires, premium audio, LED underglow, and custom camo wrap. Turns heads everywhere." },
  { id:6, title:"2018 EZGO TXT Electric", price:5950, make:"EZGO", model:"TXT", year:2018, power:"Electric", seats:2, location:"Leesburg", type:"Local", status:"Active", photo:"https://premiumqualitygolfcart.com/cdn/shop/products/2018-EZGO-TXT-Electric-2.jpg", daysLeft:8, seller:"Pat S.", phone:"(352) 555-0606", desc:"Basic but reliable 2018 EZGO TXT. New batteries in 2022, fresh tune-up, clean condition. Great starter cart or spare for guests." },
  { id:7, title:"2022 ICON i40L Lithium", price:11500, make:"ICON", model:"i40L", year:2022, power:"Lithium", seats:4, location:"The Villages", type:"Local", status:"Active", photo:"https://www.wintersgolfcarts.com/cdn/shop/products/2022-ICON-I40L-STREET-READY-Electric-Golf-Cart-Black.jpg", daysLeft:20, seller:"Nancy W.", phone:"(352) 555-0707", desc:"ICON i40L with lithium battery, full enclosure, custom seat covers, rear storage bag, and side mirrors. Perfect condition." },
  { id:8, title:"2017 Club Car DS Gas", price:4500, make:"Club Car", model:"DS", year:2017, power:"Gas", seats:2, location:"Lady Lake", type:"Local", status:"Active", photo:"https://creachgolfcarts.com/wp-content/uploads/2021/08/2017-Club-Car-Precedent-EFI-GAS.jpg", daysLeft:30, seller:"Tom H.", phone:"(352) 555-0808", desc:"Older but very solid Club Car DS gas model. Runs great, no issues. Good candidate for a custom build. Priced to sell." },
];
